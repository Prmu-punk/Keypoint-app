...
class VideoBodyObjectOptimizer:  
    def __init__(self,   
        ...
        # self.smpl_joints=json.load(open("/data/boran/4dhoi/keypoint_optimizer/human_keypoint/smpl_joints.json"))
        # #根据smpl的关节建立的关节树
        # self.joints_sim=json.load(open("/data/boran/4dhoi/keypoint_optimizer/human_keypoint/joint_sim.json"))
        #由自己标注的关节模拟smpl的关节
        # self.part_kp=json.load(open("/data/boran/4dhoi/keypoint_optimizer/human_keypoint/part_kp.json"))
